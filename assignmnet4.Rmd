...
The p-value is the measurement of how probable it is to observe test results that are more extreme than what we expected, assuming that the null hypothesis is true. 
...
"rgdp60" is a variable that presents the value of GDP per capita in 1960, converted to 1960 US dollars. In my opinion, this variable is used in order to compare countries based on their economic conditions from 1960. 
...
In my opinion, the main driver of economic growth is "tradeshare". It is the sum of exports and imports divided by GDP (from 1960 to 1995). In the second, third, and fourth models, it has significant positive coefficients and it indicates that with a higher trade share, the integration of the overall country's economy increases. 
